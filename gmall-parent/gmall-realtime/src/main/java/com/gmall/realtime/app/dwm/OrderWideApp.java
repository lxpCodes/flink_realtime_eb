...
import com.gmall.realtime.bean.OrderDetail;
...
//        orderWideDS.print("orderWide>>>>");
        ...
        orderWideWithProvinceDS.print("dim join province:>>>>>");
        ...
        orderWideWithSkuDS.print("dim join sku:>>>>");
        ...
        orderWideWithSpuDS.print("dim join spu:>>>>>");
        ...
        orderWideWithCategory3DS.print("dim join category3:>>>>>");

        //TODO 10.关联品牌维度
        SingleOutputStreamOperator<OrderWide> orderWideWithTmDS = AsyncDataStream.unorderedWait(
            orderWideWithCategory3DS,
            new DimAsyncFunction<OrderWide>("BASE_TRADEMARK") {
                @Override
                public void join(OrderWide orderWide, JSONObject jsonObject) throws Exception {
        ...
        orderWideWithTmDS.print("dim join trademark:>>>>>");
