...
import com.gmall.realtime.common.GmallConstant;
import com.gmall.realtime.bean.OrderWide;
import com.gmall.realtime.bean.PaymentWide;
import com.gmall.realtime.bean.ProductStats;
        ...
        SingleOutputStreamOperator<ProductStats> productClickAndDispalyDS = pageViewDStream.process(
            new ProcessFunction<String, ProductStats>() {
                ...
                public void processElement(String jsonStr, Context ctx, Collector<ProductStats> out) throws Exception {
                    ...
                    if (pageId == null) {
                        System.out.println("page_log>>>>" + jsonObj);
                    }
                    //获取操作时间
...
//        productClickAndDispalyDS.print("productClickAndDispaly>>>");
...
//        orderWideStatsDS.print("orderWideStats>>>");
...
//        cartStatsDS.print("cartStats>>>");
        ...
        paymentStatsDS.print("paymentStats>>>");
...
//        refundStatsDS.print("refundStats>>>");
...
//        commonInfoStatsDS.print("commonInfoStats>>>");
        ...
        productStatsWithCategoryDS.addSink(
            ClickHouseUtil
                .<ProductStats>getJdbcSink("insert into product_stats_2023 values(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)"
                ));
