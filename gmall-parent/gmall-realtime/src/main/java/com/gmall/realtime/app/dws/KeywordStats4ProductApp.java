...
import com.gmall.realtime.app.func.KeywordProductC2RUDTF;
import com.gmall.realtime.app.func.KeywordUDTF;
import com.gmall.realtime.bean.KeywordStats;
...
public class KeywordStats4ProductApp {
    public static void main(String[] args) throws Exception {
        ...
        */
        ...
        keywordStatsProductDataStream.print("keywordStatsProduct>>>");
        //TODO 8.写入到ClickHouse
        keywordStatsProductDataStream.addSink(
            ClickHouseUtil.<KeywordStats>getJdbcSink(
                "insert into keyword_stats_2023(keyword,ct,source,stt,edt,ts)  " +
                    "values(?,?,?,?,?,?)"));
