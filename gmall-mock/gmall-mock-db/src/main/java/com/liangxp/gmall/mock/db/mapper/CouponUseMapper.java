package com.liangxp.gmall.mock.db.mapper;
...
public interface CouponUseMapper extends BaseMapper<CouponUse> {
    ...
    @Results(id="couponMap", value = {
            ...
            @Result( property = "couponInfo" , column= "coupon_id" ,one = @One(select = "com.liangxp.gmall.mock.db.mapper.CouponInfoMapper.selectById") ),
            @Result( property = "couponRangeList" , column= "coupon_id" ,many = @Many(select = "com.liangxp.gmall.mock.db.mapper.CouponRangeMapper.selectById"))
            })
