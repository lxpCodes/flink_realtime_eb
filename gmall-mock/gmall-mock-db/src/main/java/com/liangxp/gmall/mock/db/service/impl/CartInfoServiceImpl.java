...
import com.liangxp.gmall.mock.db.mapper.CartInfoMapper;
import com.liangxp.gmall.mock.db.service.CartInfoService;
import com.liangxp.gmall.mock.db.service.SkuInfoService;
import com.liangxp.gmall.mock.db.service.UserInfoService;
...
public class CartInfoServiceImpl extends ServiceImpl<CartInfoMapper, CartInfo> implements CartInfoService {
    ...
    public void  genCartInfo( boolean ifClear){
        ...
        saveOrUpdateBatch(cartInfoList,10);
    }
