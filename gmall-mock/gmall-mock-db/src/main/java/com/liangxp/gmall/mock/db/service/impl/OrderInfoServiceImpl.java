...
import com.liangxp.gmall.mock.db.bean.*;
import com.liangxp.gmall.mock.db.constant.GmallConstant;
import com.liangxp.gmall.mock.db.mapper.*;
import com.liangxp.gmall.mock.db.service.*;
import com.liangxp.gmall.mock.db.util.*;
...
public class OrderInfoServiceImpl extends ServiceImpl<OrderInfoMapper, OrderInfo> implements OrderInfoService {
    ...
    public void genOrderInfos(boolean ifClear ){
        ...
        if(ifClear){
           ...
           if(orderDetailCouponList!=null&&orderDetailCouponList.size()>0){
                ...
                orderDetailCouponService.saveBatch(orderDetailCouponList,10);
           }
    ...
    public boolean saveBatch( List<OrderInfo> orderInfoList){
        super.saveBatch(orderInfoList, 10);
        ...
        return orderDetailService.saveBatch(orderDetailAllList,10);
    ...
    public void updateOrderStatus(List<OrderInfo> orderInfoList){
        ...
        saveOrUpdateBatch(orderInfoUpdateList,10);
